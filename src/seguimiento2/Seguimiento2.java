...
public class Seguimiento2 {
    ...
    public static void numeros1Al100(){
         ...
         System.out.println("Numeros incrementales del 100 al 1");
    ...
    public static void numerospares1Al150(){
        ...
        System.out.println("Numeros pares del 1 al 150");
    ...
    public static void sumaNumeros1Al200(){
        ...
        System.out.println("Suma de los número del 1 al 200");
    ...
    public static void imprimirAsteriscos(){
        ...
        System.out.println("Mostrar asteriscos");
    ...
    public static void imprimirTabla10Por10(){
           ...
           System.out.println("-------Cilo For Mostrar matriz de 10 * 10, en donde X representa los Pares y O los impares-----");
           ...
           for(int i=0; i< 10; i++){
            ...
            System.out.println("------Ciclo while Mostrar matriz de 10 * 10, en donde X representa los Pares y O los impares ---");
